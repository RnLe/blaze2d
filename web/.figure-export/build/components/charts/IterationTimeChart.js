...
exports.default = IterationTimeChart;
...
function IterationTimeChart({ width = 650, height = 380, }) {
    ...
    const renderChart = (data, polarization) => {
        const maxTime = Math.max(...data.mpb.map(d => d.time_per_iter), ...data.blaze.map(d => d.time_per_iter));
        ...
        return ((0, jsx_runtime_1.jsxs)("svg", { width: chartWidth, height: height, style: { overflow: 'visible' }, children: [(0, jsx_runtime_1.jsx)(text_1.Text, { x: 0, y: 16, fontSize: 14, fontFamily: BarChart_1.CHART_STYLES.fontFamily, fill: BarChart_1.CHART_STYLES.labelColor, fontWeight: 700, children: `Time per Iteration (${polarization})` }), (0, jsx_runtime_1.jsxs)(group_1.Group, { left: margin.left, top: margin.top, children: [(0, jsx_runtime_1.jsx)(grid_1.GridRows, { scale: yScale, width: innerWidth, stroke: BarChart_1.CHART_STYLES.gridColor, strokeOpacity: 0.4, strokeDasharray: "3,3" }), highSymmetryPoints.map((hs) => {
                            ...
                            return ((0, jsx_runtime_1.jsxs)("g", { children: [mpbTime > 0 && ((0, jsx_runtime_1.jsx)(shape_1.Bar, { x: xPos, y: yScale(mpbTime), width: barWidth, height: innerHeight - yScale(mpbTime), fill: COLORS.mpb })), blazeTime > 0 && ((0, jsx_runtime_1.jsx)(shape_1.Bar, { x: xPos + barWidth, y: yScale(blazeTime), width: barWidth, height: innerHeight - yScale(blazeTime), fill: COLORS.blaze }))] }, kIdx));
                        }), (0, jsx_runtime_1.jsx)(axis_1.AxisLeft, { scale: yScale, stroke: BarChart_1.CHART_STYLES.axisColor, tickStroke: BarChart_1.CHART_STYLES.axisColor, tickFormat: (v) => `${v.toFixed(1)}`, tickLabelProps: () => ({
                                ...
                                textAnchor: 'middle',
                                dy: 4,
                            }) }), (0, jsx_runtime_1.jsx)(text_1.Text, { x: -innerHeight / 2, y: -55, transform: "rotate(-90)", fontSize: 11, fontFamily: BarChart_1.CHART_STYLES.fontFamily, fill: BarChart_1.CHART_STYLES.labelColor, textAnchor: "middle", children: "Time per Iteration (ms)" }), (0, jsx_runtime_1.jsx)(text_1.Text, { x: innerWidth / 2, y: innerHeight + 45, fontSize: 11, fontFamily: BarChart_1.CHART_STYLES.fontFamily, fill: BarChart_1.CHART_STYLES.labelColor, textAnchor: "middle", children: "K-Point Index" })] }), (0, jsx_runtime_1.jsxs)(group_1.Group, { top: margin.top - 25, left: margin.left, children: [(0, jsx_runtime_1.jsx)("rect", { x: 0, y: -6, width: 12, height: 12, fill: COLORS.mpb }), (0, jsx_runtime_1.jsx)(text_1.Text, { x: 18, y: 4, fontSize: 11, fill: BarChart_1.CHART_STYLES.labelColor, fontFamily: BarChart_1.CHART_STYLES.fontFamily, children: "MPB" }), (0, jsx_runtime_1.jsx)("rect", { x: 60, y: -6, width: 12, height: 12, fill: COLORS.blaze }), (0, jsx_runtime_1.jsx)(text_1.Text, { x: 78, y: 4, fontSize: 11, fill: BarChart_1.CHART_STYLES.labelColor, fontFamily: BarChart_1.CHART_STYLES.fontFamily, children: "Blaze2D" })] })] }));
    };
