...
exports.default = EpsilonBarChart;
...
function EpsilonBarChart({ width = 650, height = 380, }) {
    const { data: benchmarkData, loading } = (0, use_benchmarks_1.useSeries1Benchmarks)();
    ...
    const renderChart = (data, polarization) => {
        ...
        return ((0, jsx_runtime_1.jsxs)("svg", { width: chartWidth, height: height, style: { overflow: 'visible' }, children: [(0, jsx_runtime_1.jsx)(text_1.Text, { x: 0, y: 16, fontSize: 14, fontFamily: BarChart_1.CHART_STYLES.fontFamily, fill: BarChart_1.CHART_STYLES.labelColor, fontWeight: 700, children: `Time vs Epsilon (${polarization})` }), (0, jsx_runtime_1.jsxs)(group_1.Group, { left: margin.left, top: margin.top, children: [(0, jsx_runtime_1.jsx)(grid_1.GridRows, { scale: yScale, width: innerWidth, stroke: BarChart_1.CHART_STYLES.gridColor, strokeOpacity: 0.4, strokeDasharray: "3,3" }), data.epsilons.map((eps, i) => {
                            const xPos = xScale(eps) || 0;
                            const mpbData = data.mpb[i];
                            const blazeData = data.blaze[i];
                            return ((0, jsx_runtime_1.jsxs)("g", { children: [(0, jsx_runtime_1.jsx)(shape_1.Bar, { x: xPos, y: yScale(mpbData.mean), width: barWidth, height: innerHeight - yScale(mpbData.mean), fill: COLORS.mpb, opacity: 0.8 }), mpbData.std > 0 && ((0, jsx_runtime_1.jsxs)("g", { children: [(0, jsx_runtime_1.jsx)("line", { x1: xPos + barWidth / 2, y1: yScale(mpbData.mean - mpbData.std), x2: xPos + barWidth / 2, y2: yScale(mpbData.mean + mpbData.std), stroke: COLORS.mpb, strokeWidth: 1.5 }), (0, jsx_runtime_1.jsx)("line", { x1: xPos + barWidth / 2 - 2, y1: yScale(mpbData.mean + mpbData.std), x2: xPos + barWidth / 2 + 2, y2: yScale(mpbData.mean + mpbData.std), stroke: COLORS.mpb, strokeWidth: 1.5 })] })), (0, jsx_runtime_1.jsx)(shape_1.Bar, { x: xPos + barWidth, y: yScale(blazeData.mean), width: barWidth, height: innerHeight - yScale(blazeData.mean), fill: COLORS.blaze, opacity: 0.8 }), blazeData.std > 0 && ((0, jsx_runtime_1.jsxs)("g", { children: [(0, jsx_runtime_1.jsx)("line", { x1: xPos + barWidth + barWidth / 2, y1: yScale(blazeData.mean - blazeData.std), x2: xPos + barWidth + barWidth / 2, y2: yScale(blazeData.mean + blazeData.std), stroke: COLORS.blaze, strokeWidth: 1.5 }), (0, jsx_runtime_1.jsx)("line", { x1: xPos + barWidth + barWidth / 2 - 2, y1: yScale(blazeData.mean + blazeData.std), x2: xPos + barWidth + barWidth / 2 + 2, y2: yScale(blazeData.mean + blazeData.std), stroke: COLORS.blaze, strokeWidth: 1.5 })] }))] }, eps));
                                ...
                                textAnchor: 'middle',
                                dy: 4,
                            }) }), (0, jsx_runtime_1.jsx)(text_1.Text, { x: -innerHeight / 2, y: -55, transform: "rotate(-90)", fontSize: 11, fontFamily: BarChart_1.CHART_STYLES.fontFamily, fill: BarChart_1.CHART_STYLES.labelColor, textAnchor: "middle", children: "Time per Job (ms)" }), (0, jsx_runtime_1.jsx)(text_1.Text, { x: innerWidth / 2, y: innerHeight + 45, fontSize: 11, fontFamily: BarChart_1.CHART_STYLES.fontFamily, fill: BarChart_1.CHART_STYLES.labelColor, textAnchor: "middle", children: "Dielectric Constant (\u03B5)" })] }), (0, jsx_runtime_1.jsxs)(group_1.Group, { top: margin.top - 25, left: margin.left, children: [(0, jsx_runtime_1.jsx)("rect", { x: 0, y: -6, width: 12, height: 12, fill: COLORS.mpb, opacity: 0.8 }), (0, jsx_runtime_1.jsx)(text_1.Text, { x: 18, y: 4, fontSize: 11, fill: BarChart_1.CHART_STYLES.labelColor, fontFamily: BarChart_1.CHART_STYLES.fontFamily, children: "MPB" }), (0, jsx_runtime_1.jsx)("rect", { x: 60, y: -6, width: 12, height: 12, fill: COLORS.blaze, opacity: 0.8 }), (0, jsx_runtime_1.jsx)(text_1.Text, { x: 78, y: 4, fontSize: 11, fill: BarChart_1.CHART_STYLES.labelColor, fontFamily: BarChart_1.CHART_STYLES.fontFamily, children: "Blaze2D" })] })] }));
    };
