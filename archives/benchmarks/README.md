...
These pre-0.7 scripts document the archived datasets. They require the original solver interface and directory layout. Current measurements use `benchmarks/run.py` at the repository root.
